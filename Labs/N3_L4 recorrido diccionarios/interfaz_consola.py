...
import modulo_vuelos as lib_vuelos
...
def ejecutar_vuelos_directos(vuelos: dict)->None:
    ...
    if len(vuelos_directos) == 0:
        ...
        print("Los vuelos directos entre ", origen, "y", destino, "son:")
...
def ejecutar_vuelos_con_una_escala(vuelos: dict)->None:
    ...
    if len(vuelos_escala) == 0:
        ...
        print("Los vuelos con una escala entre ", origen, "y", destino, "son:")
        for item in vuelos_escala:
            print(item)
...
def ejecutar_generar_reporte_adelantados(vuelos:dict)->None:
    print("Se generará el reporte de vuelos adelantados")
    lib_vuelos.generar_reporte_adelantados(vuelos)
...
def mostrar_menu()->None:
    ...
    print("5. Generar reporte de vuelos adelantados")
    print("6. Salir")
...
def iniciar_aplicacion()->None:
    ...
    while continuar:
        ...
        if opcion == 1:
            ...
            ejecutar_generar_reporte_adelantados(vuelos)
        elif opcion == 6:
            continuar = False
        else:
