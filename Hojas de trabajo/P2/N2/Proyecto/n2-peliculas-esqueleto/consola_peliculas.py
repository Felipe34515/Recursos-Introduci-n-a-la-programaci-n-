...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    rta = mod.duracion_promedio_peliculas(p1,p2,p3,p4,p5)
    print("La duracion promedio de las peliculas es: " + str(rta) )
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    rta = mod.encontrar_estrenos(p1,p2,p3,p4,p5, anio)
    print(rta)
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    rta = mod.cuantas_peliculas_18_mas(p1,p2,p3,p4,p5)
    print("Hay " + str(rta) + " peliculas con clasificacion 18+")
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        nuevo_hora = int(input("Ingrese la nueva hora de la pelicula (formato 24 horas): "))
        control_horario = input("Ingrese el control de horario (Y/N): ")
        if control_horario == "Y":
            control_horario = True
        else:
            control_horario = False
        rta = mod.reagendar_pelicula(pelicula, nuevo_dia, nuevo_hora, control_horario, p1, p2, p3, p4, p5  )
        if rta:
            print("La pelicula ha sido reagendada")
        else:
            print("No se puede reagendar la pelicula")
