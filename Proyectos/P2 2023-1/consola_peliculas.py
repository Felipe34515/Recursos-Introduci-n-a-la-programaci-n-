...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict )->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    anio = int(input("Digita año de estreno: "))
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        nueva_hora = int(input("Ingresa la nueva hora de la pelicula: "))
        nuevo_dia =  input("Ingresa el nuevo dia para la pelicula: ")
        control_horario = False
        resp =  int(input("Ingresa 1 si desea controlar el horario, de lo contrario ingresa 0: "))
        if(resp == 1):
            control_horario = True
            print(mod.reagendar_pelicula(pelicula,nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5))
        else:
            print(mod.reagendar_pelicula(pelicula,nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5))
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        edad_invitado = int(input("Ingresa la edad del invitado: "))
        if(edad_invitado >= 18):
            print(mod.decidir_invitar(pelicula, edad_invitado,autorizacion))
        else: 
            
            resp = int(input("Ingresa 1 si estas autorizaco por tus padres, de lo contrario ingresa 0: "))
            if(resp == 1):
                autorizacion = True
                print(mod.decidir_invitar(pelicula, edad_invitado,autorizacion))
            else:
